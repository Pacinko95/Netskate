                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">     
                                ...
                                <?php }else{  ?>
                                    <img src="<?= base_url(@$data->img)?>" style="height: 200px;width: 200px" id="img"> 
                                <?php }  ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="dob" id="dp-3" class="form-control datepicker" value="<?= @$data->dob ?>" data-date="06-06-2014" data-date-format="dd-mm-yyyy" data-date-viewmode="years" readonly>
                            </div>
                        </div>
                    </div>
