                ...
                <?php foreach($data as $d){?>
                    <tr>
                        <td style="width: 150px">
                            <a href="<?= base_url('eo/form_invoice/'.$d->code_invoice)?>" class="btn btn-default btn-rounded btn-sm" title="DETAIL">
                            <span class="fa fa-pencil"></span></a>
                            <?php if($d->id_status ==5){ ?>
                                <a href="<?= base_url('invoice/print_invoice/'.$d->code_invoice)?>" class="btn btn-default btn-rounded btn-sm" title="PRINT"target="_blank">
