<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading ui-draggable-handle">
            <h3 class="panel-title"><strong>Update</strong> Race</h3>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">                                            
                            <div class="input-group">
                                ...
                                <input type="checkbox" name="rp" value="1" style="margin-top: 10px;" value="1" <?php if(!empty(@$data->rp)){ echo 'checked';}?> >
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-4">                                            
                            <div class="input-group">
                                <!-- <input type="checkbox" class="form-control" value="1" name="rp"> -->
                                <input type="checkbox" name="team" value="1" style="margin-top: 10px;" <?php if(!empty(@$data->team)){ echo 'checked';}?> >
