            ...
            <div class="panel-body">
                ...
                <table class="table datatable" >
                   ...
                   <?php foreach($race as $d){?>
                         <tr>
                            <th width="200px">
                            <a href="<?= base_url('event/race_update/'.$d->id)?>" class="btn btn-default btn-rounded btn-sm" title="EDIT">
                            <span class="fa fa-pencil"></span></a>
                            <a href="<?= base_url('event/race_delete/'.$d->id)?>" class="btn btn-default btn-rounded btn-sm" title="DELETE">
