                ...
                <div class="rows">
                    ...
                    <div class="column-form-login">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter No Hp">
                        </div>
                        <div class="form-group">
                        ...
                        <br/>
                        <p>you have a account ? <a href="<?php echo base_url($this->uri->segment(1)) ?>" style="color:#2B3E4E"><strong><u>Login Now</u></strong></a></p>
                        </div>
                    </div>
                </div>
            </div>
