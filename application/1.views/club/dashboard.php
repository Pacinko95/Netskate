<div class="row">
    <div class="col-md-3">
        ...
        <div class="widget widget-default widget-item-icon" >
            <div class="widget-item-left">
				<img src="<? echo base_url().'assets/img/icon/beginner.png'; ?>" style="width:50px; height:50px;color:red;" />
    ...
    <div class="widget widget-default widget-item-icon" >
        <div class="widget-item-left">
            <img src="<? echo base_url().'assets/img/icon/standard.png'; ?>" style="width:50px; height:50px;color:red;" />
        ...
        <div class="widget-data">
            ...
            <div class="widget-title">STANDARD</div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-default widget-item-icon">
                                <div class="widget-item-left">
                                    <img src="<? echo base_url().'assets/img/icon/speed.png'; ?>" style="width:50px; height:50px;color:red;" />
                        ...
                        <div class="col-md-3">
                            ...
                            <!-- START WIDGET CLOCK -->
                                 <div class="widget widget-default widget-item-icon">
                                <div class="widget-item-left">
									<img src="<? echo base_url().'assets/img/icon/skatecross.png'; ?>" style="width:50px; height:50px;color:red;" />
