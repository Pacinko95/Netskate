...
<html lang="en">
    ...
    <body>
      ...
      <div class="preloader">
        <div class="loading">
          <img src="<?= base_url('assets/Wedges-3s-200px.gif')?>" width="100">
          <p>Please wait ...</p>
        </div>
      </div>
            ...
            <div class="page-sidebar page-sidebar-fixed scroll">
                ...
                <ul class="x-navigation">
                    ...
                    <li>
                       ...
                       <li><a href="<?= base_url('athlete/profil')?>><span class="fa fa-desktop"></span> <span class="xn-text">PROFIL</span></a></li>
                       <li><a href="<?= base_url('athlete/event')?>"><span class="fa fa-desktop"></span> <span class="xn-text">EVENT</span></a></li>
                       <li><a href="<?= base_url('invoice')?>"><span class="glyphicon glyphicon-usd"></span> <span class="xn-text">INVOICE</span></a></li>
