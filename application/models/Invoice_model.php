    ...
    class Invoice_model extends CI_Model {
        ...
        public function select($id = null)
        {
            ...
            if($_SESSION['type'] == 2){
                ...
                $sql = $this->db->join('tbl_status b','b.id = a.status','left')->join('tbl_event c','a.id_event= c.id','left')->group_by('code_invoice')->select(" c.name as name_event , a.code_invoice, DATE_FORMAT(a.create_date, '%d/%m/%Y') as create_date, b.name as status, a.status as id_status,  format( SUM(a.payment + a.code_payment), 0) as hasil, a.code_payment")->where('id_athlete', $id)->get('tbl_invoice a')->result();
            }
            // die($id);
