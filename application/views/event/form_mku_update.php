    ...
    <form class="form-horizontal" action="<?= base_url('event/save_mku/'.$this->uri->segment(3))?>" method="POST" enctype="multipart/form-data">
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">
                <h3 class="panel-title"><strong>Update</strong> MKU</h3>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" value="<?= @$data->age_start?>" name="age_start" min="0">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" value="<?= @$data->age_end?>" name="age_end" min="1">
                                        <span class="input-group-addon">thn</span>
                                    </div> 
                                    <span class="help-block" style="color: red; font-size: 8px;"><?php echo form_error('name'); ?></span>                                           
                                </div>
                            ...
                            <div class="col-md-9">                                            
                                <div class="input-group">
                                    <select class="form-control" name="id_class">
                                        ...
                                        <option value="<?= $c->id ?>" <?php if($c->id == $data->id_class){echo "selected";} ?> ><?= $c->name ?></option>   
                                        <?php } ?>
                                    </select>
