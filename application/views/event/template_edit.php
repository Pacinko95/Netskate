<div class="col-md-12">
    <form class="form-horizontal" action="<?= base_url('event/update_template/'.$this->uri->segment(3))?>" method="POST" enctype="multipart/form-data">
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">
                <h3 class="panel-title"><strong>Update</strong> Template</h3>
            </div>
