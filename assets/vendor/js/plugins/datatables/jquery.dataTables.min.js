...
(function(za, O, l) {
    var N = function(h) {
        ...
        function P(a, b, c, d) {
            c = "For more information about this error, please email to misnu88@gmail.com";
            // "DataTables warning: " + (null !== a ? "table id=" + a.sTableId + " - " : "") + c;
            // d && (c += ". For more information about this error, please see http://datatables.net/tn/" + d);
             // d && (c += ". For more information about this error, please email to misnu88@gmail.com");
            if (b) za.console &&
